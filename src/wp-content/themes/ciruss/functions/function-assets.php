...
function course_add_css_js() {
    ...
    wp_enqueue_style('aos-css', get_template_directory_uri() . '/assets/css/aos.css?time=' . time(), array(), false);
    wp_enqueue_style('main-css', get_template_directory_uri() . '/assets/css/main.css?time=' . time(), array(), false);
    
    // ADD JS
    wp_enqueue_script('main-jquery', get_template_directory_uri() . '/assets/js/jquery.js', array(), false, true);
    wp_enqueue_script('boostrap-min', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), false, true);
...
// function link
function ciruss_get_link( $key_name ) {
...
// function link title
function ciruss_get_link_title( $key_name ) {
    if (isset( $key_name ) && is_array( $key_name )) {
